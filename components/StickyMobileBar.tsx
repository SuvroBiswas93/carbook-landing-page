...
export function StickyMobileBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-2 border-t border-white/20 shadow-[0_-8px_24px_rgba(11,37,69,.18)] sm:hidden">
      ...
      <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noreferrer" className="flex min-h-13 items-center justify-center gap-2 bg-brand-whatsapp px-3 text-sm font-bold text-white">
