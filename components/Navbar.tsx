      ...
      <div className="mx-auto flex min-h-18 max-w-7xl items-center justify-between gap-2 px-3 sm:gap-4 sm:px-6 md:max-lg:gap-2 md:max-lg:px-4 lg:px-8">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <a
            ...
            className="hidden size-11 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.35)] transition duration-300 hover:-translate-y-0.5 hover:scale-105 hover:shadow-[0_12px_30px_rgba(37,211,102,0.5)] hover:ring-4 hover:ring-[#25D366]/25 md:inline-flex"
          >
