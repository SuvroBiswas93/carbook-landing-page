...
function Header({ onMenuOpen }: { onMenuOpen: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between gap-3 border-b border-[#e7e0d5] bg-[#fffdf9] px-4 sm:h-20 sm:px-8">
      ...
      <Link
        href="/"
        className="flex shrink-0 items-center gap-2 rounded-xl bg-[#292724] px-3 py-2 text-xs font-bold text-white transition-colors hover:bg-[#3a382f] sm:px-4 sm:py-2.5 sm:text-sm"
      >
        <Home size={16} />
